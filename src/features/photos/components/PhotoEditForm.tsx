...
import { MAX_TAG_LENGTH, MAX_ALBUM_NAME_LENGTH } from '@/shared/constants';
import {
  AlbumsSelector,
  DateInput,
  FamilyOnlyCheckbox,
  ...
  TagsSelector,
  TitleInput,
} from '@/features/photos/components/edit';
import { Tag, Album } from '@/shared/types/shared-types';
...
interface PhotoEditFormProps {
  ...
  allAlbums: Album[];
  onCancel: () => void;
  onSave: (updatedPhoto: PhotoWithAlbums) => void | Promise<void>;
}
